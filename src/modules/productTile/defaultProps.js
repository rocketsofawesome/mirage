...
const productOnSale = {
  product: {
    ...
    nav_categories: ['Boys New Arrivals', 'Swim', 'Boys', 'Swimwear'],
    skus: [
      {
        size: ['OS'],
        in_stock: true
    ...
    code: 'A222-C01',
    category: ['Swim', 'Swim Accessories'],
...
const productWithVariants = {
  product: {
    ...
    description:
      'If these don\'t scream "summer camp, 1982" we don\'t know what does. Made from supersoft and quick-drying terrycloth, with convenient side pockets and a cute embroidered pineapple, these shorts for sure have a place in her weekly rotation.',
    details:
      '* 65% Polyester, 35% Rayon\r* Machine wash cold gentle cycle\r* Only non-chlorine bleach\r* Tumble dry low\r* Cool iron if needed',
    id: '1809-7254-300',
    product_id: 1809,
